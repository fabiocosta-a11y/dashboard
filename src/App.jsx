          ...
          <div style={S.card}>
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={S.table}>
                <thead>
                  <tr>
                    {["","Ordem","Descrição","Base","Categoria","Valor","Status","Acumulado","Situação",""].map((h, i) => (
                    ...
                    return (
                      <React.Fragment key={f.id}>
                        <tr style={{ opacity: f.cabe ? 1 : 0.5 }}>
                          ...
                          <td style={{ ...S.td, textAlign: "center" }}>
                            <button onClick={() => delRow("despesa", f.id)} style={S.del}>×</button>
                          </td>
                        </tr>
                        {cutoff && (
                          <tr><td colSpan={10} style={S.cutoff}>
