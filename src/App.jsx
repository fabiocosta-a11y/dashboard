...
const PAINEL_CARDS = [
  ...
  { key: "cac", label: "CAC", icon: "🎯", tipo: "manual", formato: "moeda" },
...
function AppInner({ onLogout }) {
  ...
  }), [clientesAtivos, inadimplentes, totEntradasMes, totSaidasMes, receitaRecorrente, receitaMediaCliente, totalPipeline, tempoMedioCliente]);
