...
function AppInner({ onLogout }) {
  ...
  // ── CRUD ──────────────────────────────────────────────────
  const emptyRow = { desc: "", base: basesDe(empresa)[0], categoria: "", periodo: "Mensal", venc: 1, valor: 0, status: "Prioridade", mesInicio: mes, anoInicio: ano, clienteMes: mes, clienteAno: ano };
  ...
  const addRow = () => {
    ...
    setForm({ ...emptyRow, mesInicio: mes, anoInicio: ano, clienteMes: mes, clienteAno: ano });
  };
