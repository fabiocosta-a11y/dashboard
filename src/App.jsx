...
const PAINEL_CARDS = [
  ...
  { key: "lucro", label: "Lucro", icon: "💰", tipo: "manual", formato: "moeda" },
                ...
                return (
                  <div key={c.key} style={S.painelCard}>
                    ...
                    <div style={S.painelCardVar}>
                      {auto ? (
                        <span style={{ color: "#4ade80" }}>{c.key === "entradas" ? "Mês atual" : c.key === "clientesAtivos" ? "recorrentes únicos" : c.key === "receitaRecorrente" ? "MRR (mensal)" : c.key === "receitaMedia" ? "por cliente ativo" : "automático"}</span>
                      ) : (
                        <EditCell
                          value={variacao}
                          muted
