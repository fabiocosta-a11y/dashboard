...
const PAINEL_CARDS = [
  { key: "clientesAtivos", label: "Clientes ativos", icon: "👥", tipo: "manual", formato: "numero" },
...
function AppInner({ onLogout }) {
  ...
  }), [totEntradasMes, totSaidasMes, totalPipeline]);
                ...
                return (
                  <div key={c.key} style={S.painelCard}>
                    ...
                    <div style={S.painelCardVar}>
                      {auto ? (
                        <span style={{ color: "#4ade80" }}>{c.key === "entradas" ? "Mês atual" : "automático"}</span>
                      ) : (
                        <EditCell
                          value={variacao}
                          muted
