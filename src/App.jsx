...
const PAINEL_CARDS = [
  ...
  { key: "receitaRecorrente", label: "Receita recorrente", icon: "📈", tipo: "manual", formato: "moeda" },
  { key: "receitaMedia", label: "Receita média por cliente", icon: "🧑", tipo: "manual", formato: "moeda" },
...
function AppInner({ onLogout }) {
  ...
  }), [clientesAtivos, totEntradasMes, totSaidasMes, totalPipeline]);
                ...
                return (
                  <div key={c.key} style={S.painelCard}>
                    ...
                    <div style={S.painelCardVar}>
                      {auto ? (
                        <span style={{ color: "#4ade80" }}>{c.key === "entradas" ? "Mês atual" : c.key === "clientesAtivos" ? "recorrentes únicos" : "automático"}</span>
                      ) : (
                        <EditCell
                          value={variacao}
                          muted
