                    ...
                    <div style={S.painelCardVar}>
                      {auto ? (
                        c.key === "cac" ? (
                          ...
                          <span style={{ color: "#4ade80" }}>{c.key === "entradas" ? "Mês atual" : c.key === "clientesAtivos" ? "recorrentes únicos" : c.key === "receitaRecorrente" ? "MRR (mensal)" : c.key === "receitaMedia" ? "por cliente ativo" : c.key === "lucro" ? "entradas − saídas" : c.key === "inadimplentes" ? "vencidos não pagos" : c.key === "tempoMedio" ? "desde o 1º contrato" : c.key === "conversao" ? "ganhos ÷ total de leads" : "automático"}</span>
                        )
                      ) : (
                        <EditCell
                          value={variacao}
